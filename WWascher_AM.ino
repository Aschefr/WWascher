...
//ACTION EN MANUEL :
    ...
    if (data == "Manu_001PO_Off" || digitalRead(in001SP) == 1) {
      pump_001PO->turnOff();
    }
    ...
    if (data == "Manu_002PO_Off" || digitalRead(in001SP) == 1) {
      pump_002PO->turnOff();
    }
    ...
    if (data == "Manu_003PO_Off" || digitalRead(in001SP) == 1) {
      pump_003PO->turnOff();
    }
